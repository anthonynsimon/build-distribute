...
Route::group(['middleware' => ['web', 'auth', 'force.ssl']], function () {
    ...
    Route::post('/builds/{buildId}/tags', 'BuildTagsController@assignBuildTag');
    Route::delete('/builds/{buildId}/tags/{tagId}', 'BuildTagsController@removeBuildTag');
